...
# Test 5 (it is on window 4):
    title = 'Problem 3a. Test 5: Start at (40, 50), 20 lines'
...
def problem3b(m, point1):
    ...
    for z in range (1,m+1):
        for k in range(1, (2*(z+1))):
            line = rg.Line(rg.Point(point1.x + 20 * k, point1.y + (10 * k)+(60*z)),
                           rg.Point(point1.x + 20 * k, point1.y + 50 + (10 * k)+(60*z)))
            line.thickness = (2 * k) - 1
            if line.thickness > 13:
                line.thickness = 13
            total = total + line.thickness
